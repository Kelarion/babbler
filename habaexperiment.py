"""
Neural Grammer (a.k.a. syntactotron)

Training RNNs to recognise (i.e. parse) sequences from (formal) language.

Command-line arguments:
    -v [--verbose]  set verbose
    -n val          number of neurons (int)
    -q val          size of subalphabet (int)
    -l val          parameter of the grammar (int)
...
if socket.gethostname() == 'kelarion':
    CODE_DIR = '/home/matteo/Documents/github/babbler/'
    SAVE_DIR = '/home/matteo/Documents/github/babbler/'
else:    
    CODE_DIR = '/rigel/home/ma3811/neural-grammar/'
...
if len(opts) == 0:
    sys.exit('No arguments supplied! I`m guessing you wanted the help text: \n'
             ...
             ' -v, --verbose   set verbose \n'
             ' -n val          number of neurons (int) \n'
             ' -l val          length of training sequences (int) \n'
             ' -q val          maximum (int); default None \n'
